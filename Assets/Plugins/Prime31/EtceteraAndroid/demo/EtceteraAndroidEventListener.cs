...
namespace Prime31
{
	public class EtceteraAndroidEventListener : MonoBehaviour
	{
		...
		void onRequestPermissionsResultEvent( EtceteraAndroidManager.PermissionsResult result )
		{
			Debug.Log( "onRequestPermissionsResultEvent" );
		...
		{
			Debug.LogFormat( "webViewDidLoadURLEvent: {0}", url );
		}
