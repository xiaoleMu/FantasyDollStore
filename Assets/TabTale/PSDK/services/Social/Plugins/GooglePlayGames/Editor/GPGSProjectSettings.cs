    ...
    public class GPGSProjectSettings
    {
        ...
        private GPGSProjectSettings()
        {
            ...
            string[] fileLocations =
                {
                    mFile,
                    "Assets/Tabtale/PSDK/services/Social/Plugins/GooglePlayGames/Editor/projsettings.txt".Replace("/", ds),
                    "Assets/Tabtale/PSDK/services/Social/Editor/projsettings.txt".Replace("/", ds)
                };
