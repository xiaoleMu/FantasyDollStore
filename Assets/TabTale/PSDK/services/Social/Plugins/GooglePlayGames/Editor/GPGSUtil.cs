...
namespace GooglePlayGames.Editor
{
    ...
    public static class GPGSUtil
    {
        ...
        /// </summary>
		private const string GameInfoPath = "Assets/Tabtale/PSDK/services/Social/Plugins/GooglePlayGames/GameInfo.cs";
        ...
        private const string ManifestPath =
			"Assets/Tabtale/PSDK/services/Social/Plugins/Android/MainLibProj/AndroidManifest.xml";
	    
	private const string ResIdPath =
		"Assets/Tabtale/PSDK/services/Social/Plugins/Android/MainLibProj/res/values/ids.xml";
        ...
        {
			return ReadFile(SlashesToPlatformSeparator("Assets/Tabtale/PSDK/services/Social/Plugins/GooglePlayGames/Editor/" + name + ".txt"));
        }
