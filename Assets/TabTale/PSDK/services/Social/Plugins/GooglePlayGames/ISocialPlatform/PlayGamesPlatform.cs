...
namespace GooglePlayGames
{
    ...
    {
		private Action<UIStatus> showUIDelegate;
		public Action<UIStatus> ShowUIDelegate {
			get {
				return showUIDelegate;
			}
			set {
				showUIDelegate = value;
			}
		}
        ...
        {
			ShowAchievementsUI(showUIDelegate);
        }
        ...
        public void ShowLeaderboardUI()
        {
			...
			ShowLeaderboardUI(MapId(mDefaultLbUi), showUIDelegate);
        }
