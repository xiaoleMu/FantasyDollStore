...
public class JsonMapper {
	...
	public static string ToJson(object obj,bool typeHinting = false) {
		JsonWriter writer = new JsonWriter();
		writer.TypeHinting = typeHinting;
	...
	public static T ToObject<T>(string json, bool typeHinting = false) {
		JsonReader reader = new JsonReader(json);
		reader.TypeHinting = typeHinting;
		return (T)ReadValue(typeof(T), reader);
	}
