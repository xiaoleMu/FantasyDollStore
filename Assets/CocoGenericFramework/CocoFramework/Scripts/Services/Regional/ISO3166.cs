...
public static class ISO3166
{
	...
	private static Collection<ISO3166Country> Collection 
	{
		get
		{
			if (_collection == null)
	...
	private static Collection<ISO3166Country> BuildCollection()
	{
		...
		collection.Add(new ISO3166Country("Antigua", "AG", "ATG", 28));
		...
		collection.Add(new ISO3166Country("Bonaire", "BQ", "BES", 535));
		...
		collection.Add(new ISO3166Country("Congo", "CD", "COD", 180));
		...
		collection.Add(new ISO3166Country("Heard Island", "HM", "HMD", 334));
		...
		collection.Add(new ISO3166Country("Korea", "KP", "PRK", 408));
		...
		collection.Add(new ISO3166Country("Lao", "LA", "LAO", 418));
		...
		collection.Add(new ISO3166Country("Macedonia", "MK", "MKD", 807));
		...
		collection.Add(new ISO3166Country("Micronesia", "FM", "FSM", 583));
		...
		collection.Add(new ISO3166Country("Northern Mariana", "MP", "MNP", 580));
		...
		collection.Add(new ISO3166Country("Saint Helena", "SH", "SHN", 654));
		...
		collection.Add(new ISO3166Country("Saint Martin", "MF", "MAF", 663));
		collection.Add(new ISO3166Country("Saint Pierre", "PM", "SPM", 666));
		collection.Add(new ISO3166Country("Saint Vincent", "VC", "VCT", 670));
		collection.Add(new ISO3166Country("Samoa", "WS", "WSM", 882));
		collection.Add(new ISO3166Country("San Marino", "SM", "SMR", 674));
		collection.Add(new ISO3166Country("Sao Tome", "ST", "STP", 678));
		...
		collection.Add(new ISO3166Country("Sint Maarten", "SX", "SXM", 534));
		...
		collection.Add(new ISO3166Country("South Georgia", "GS", "SGS", 239));
		...
		collection.Add(new ISO3166Country("Svalbard", "SJ", "SJM", 744));
		...
		collection.Add(new ISO3166Country("Syria", "SY", "SYR", 760));
		...
		collection.Add(new ISO3166Country("Turks and Caicos", "TC", "TCA", 796));
		...
		collection.Add(new ISO3166Country("United Kingdom", "GB", "GBR", 826));
		collection.Add(new ISO3166Country("USA", "US", "USA", 840));
		collection.Add(new ISO3166Country("USA", "UM", "UMI", 581));
		...
		collection.Add(new ISO3166Country("Virgin Islands", "VG", "VGB", 92));
		collection.Add(new ISO3166Country("Virgin Islands", "VI", "VIR", 850));
